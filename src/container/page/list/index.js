...
import ListContent from '../../../component/control/listProduct'
...
class Content extends React.PureComponent {
  ...
  render () {
    return <>
      ...
      <div id='product_product_content' className='container'>
        <div className='row'>
          <Nav nav={this.props.nav || []} />
          <ListContent pageSize={this.state.pageSize} total={this.state.total} catId={this.props.catId} page={this.props.page} onChangePaging={this.onChangePaging} nextPage={this.nextPage} prevPage={this.prevPage} products={this.state.products || []} />
        </div>
      </div>
    </>
  }
